...
export function Contact() {
  // Contact information
  const contactInfo = {
    name: 'Aayush Gautam Giraud',
    email: 'Aayush Gautamgiraud12@gmail.com',
    handle: '@Aayush Gautam.Giraud',
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/aayush-gautam-25b9a5247/',
      },
      {
        name: 'Youtube',
        url: 'https://www.youtube.com/channel/UC3VaAV_PQ4ZWZ9TKua7LPwQ',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/epein5/',
      },
      {
        name: 'Discord',
        url: 'https://discord.com/users/epein.',
      },
      {
        name: 'Github',
        url: 'https://github.com/Epein5',
      },
      {
        name: 'X',
        url: 'https://x.com/Epein5',
      },
    ],
  };
