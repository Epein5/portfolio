...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Raph also known as Epein5. I'm a developer specializing in AI at Naxal, Kathmandu. I'm working at LightOn AI in Paris. I'm passionate about AI, tech, Entrepreneurship and SaaS tech.",
    src: '/profil-raph.png',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Developer', 'Naxal, Kathmandu', 'Sport', 'SaaS Builder'].map(
              (tag) => (
                <span
                  key={tag}
